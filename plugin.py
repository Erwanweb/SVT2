...
<plugin key="SVT2" name="AC Smart Virtual Thermostat for ON/OFF heater" author="Erwanweb" version="0.0.2" externallink="https://github.com/Erwanweb/SVT2.git">
    ...
    <params>
        ...
        <param field="Mode5" label="Calculation cycle, Minimum Heating time per cycle, Pause On delay, Pause Off delay, Forced mode duration, Presence On delay, Presence Off delay (all in minutes), reduc jour, reduc nuit (both in tenth of degre)" width="200px" required="true" default="30,0,2,1,60,5,60,1,2"/>
